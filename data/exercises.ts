...
export const SESSIONS: Session[] = [
  { 
    ...
    ejercicios: [
      's1_w_1', 's1_w_2', 's1_w_3', 's1_w_4', 's1_w_5', 's1_w_6', // 6 Calentamiento
      's1_r_1', 's1_r_2', 's1_r_3', 's1_r_4', 's1_r_5', 's1_r_6', // 6 Resistencia
      's1_c_1', 's1_c_2', 's1_c_3', 's1_c_4', 's1_c_5', 's1_c_6', 's1_c_7' // 7 Enfriamiento
    ] 
  }
];
