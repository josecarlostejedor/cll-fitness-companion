...
def generate_docx(session_id):
    ...
    # Iterar por fases con salto de página por fase
    ...
    # SECCIÓN: COMPROMISO DIARIO (Nueva Página)
    doc.add_page_break()
    ...
    # SECCIÓN: INSTRUCCIONES (Nueva Página)
    doc.add_page_break()
    ...
    p_inst.add_run(" por sesión. Al terminar el enfriamiento, descanse 3 minutos antes de volver a empezar desde el calentamiento.")
    
    # SECCIÓN: ESCALA DE BORG (Nueva Página)
    doc.add_page_break()
    doc.add_heading('ESCALA DE BORG', level=1)
    doc.add_paragraph("Nos referimos a medir la percepción del esfuerzo, mientras realizamos actividad física.")
    
    borg_data = [
        ("0", "Reposo"), ("1", "Muy, muy ligero"), ("2", "Muy ligero"), ("3", "Ligero"),
        ("4", "Algo pesado"), ("5", "Pesado"), ("6", "Más pesado"), ("7", "Muy pesado"),
        ("8", "Muy, muy pesado"), ("9", "Máximo"), ("10", "Extremo")
    ]
