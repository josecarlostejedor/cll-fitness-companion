...
EXERCISES = {
    ...
    'r_curl_db': {'nombre': 'Curl Bíceps', 'desc': 'Flexión de codos con carga.', 'img': 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=600&q=80', 'parte': 'Resistencia', 'rpe': 7, 'plan': '3 x 12'},
    'r_row_db': {'nombre': 'Remo Mancuerna', 'desc': 'Tracción hacia la cadera.', 'img': 'https://images.unsplash.com/photo-1594737625785-a239f56d0bdc?w=600&q=80', 'parte': 'Resistencia', 'rpe': 7, 'plan': '3 x 12'},
...
if page == "👤 Perfil Paciente":
    ...
    st.title("Configuración de 1RM")
    st.write("Ingrese el peso máximo (1RM) para que el sistema calcule el 70% terapéutico.")
