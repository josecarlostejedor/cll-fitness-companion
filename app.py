...
# --- DATOS RESTAURADOS DIRECTAMENTE EN EL ARCHIVO ---
EXERCISES = {
    # SESIÓN 1
    ...
    's1_w_4': {'nombre': 'Sentadilla pared', 'desc': 'Isometría en pared.', 'img': 'images/sentadilla_pared.jpg', 'parte': 'Calentamiento', 'rpe': 6, 'plan': '1 min'},
    's1_w_5': {'nombre': 'Saltar', 'desc': 'Saltos controlados.', 'img': 'images/saltar.jpg', 'parte': 'Calentamiento', 'rpe': 6, 'plan': '2 min'},
    's1_w_6': {'nombre': 'Lanzamientos pelota', 'desc': 'Lanzar y recibir.', 'img': 'images/lanzamientos.jpg', 'parte': 'Calentamiento', 'rpe': 6, 'plan': '2 min'},
    's1_r_1': {'nombre': 'Sentadilla peso corporal', 'desc': 'Flexión cadera/rodillas.', 'img': 'images/sentadilla_libre.jpg', 'parte': 'Resistencia', 'rpe': 7, 'plan': '12 rep'},
    's1_r_2': {'nombre': 'Peso muerto rumano', 'desc': 'Bisagra de cadera.', 'img': 'images/peso_muerto.jpg', 'parte': 'Resistencia', 'rpe': 7, 'plan': '12 rep'},
    ...
    # (Se asume la existencia de los otros ejercicios para s2, s3, s4 siguiendo el mismo patrón)
}
...
SESSIONS = [
    ...
    {'id': 2, 'nombre': "Sesión 2: Potencia Dinámica", 'ejercicios': []}, # Completar con IDs reales
    {'id': 3, 'nombre': "Sesión 3: Fuerza Integral", 'ejercicios': []},
    {'id': 4, 'nombre': "Sesión 4: Control y Empuje", 'ejercicios': []}
]
...
def generate_docx(session_id):
    ...
    # Configuración de secciones (Encabezado y Pie)
    ...
    phases = [('Calentamiento', 'CALENTAMIENTO'), ('Resistencia', 'RESISTENCIA'), ('Enfriamiento', 'ENFRIAMIENTO')]
    ...
    for phase_key, phase_title in phases:
        ...
        # Instrucciones inmediatamente después de Enfriamiento
        if phase_key == 'Enfriamiento':
            ...
            p_inst.add_run(" por sesión. Al terminar el enfriamiento, descanse 3 minutos antes de volver a empezar desde el calentamiento. Caminar 60 minutos cada día de la semana para combatir la fatiga oncológica.").font.size = Pt(11)
    ...
    doc.add_paragraph("Mide la percepción del esfuerzo durante la actividad física. Marque su sensación con una X.")
...
if page == "👤 Perfil Paciente":
    ...
    res_exs = {k: v for k, v in EXERCISES.items() if v['parte'] == 'Resistencia'}
    ...
    ex_ids = [eid for eid in active_sess['ejercicios'] if eid in EXERCISES]
    if ex_ids:
        cols = st.columns(3)
        ...
        st.info("Sesión pendiente de cargar ejercicios.")
